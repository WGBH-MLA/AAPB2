          ...
          it 'works' do
            ...
            expect(
              page.all('#documents/div').map do |doc|
                ...
                ['Episode Number: Musical Encounter', 'Episode Number: 116', 'Episode Number: Music for Fun', 'Created: 1988-05-12', 'Organization: Iowa Public Televisio', 'Media Type: Moving Image', 'Access: Online Reading Room'],
