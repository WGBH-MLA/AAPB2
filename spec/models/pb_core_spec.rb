    ...
    describe '.to_solr' do
      it 'constructs values for solr_document from pbcore xml' do
        ...
        expected_attrs = {
          ...
          'series_titles' => ['Nova'],
          'special_collections' => [],
          'text' => ["Moving Image", "Album", "Massachusetts", "2000-01-01", "Date", "Series", "Nova", "Program", "Gratuitous Explosions", "Episode Number", "3-2-1", "Episode", "Kaboom!", "Best episode ever!", "Copy Left: All rights reversed.", "Copy Right: Reverse all rights.", "Call-in", "Music", "explosions -- gratuitious", "musicals -- horror", "Larry", "balding", "Stooges", "WGBH", "Producing Organization", "Curly", "bald", "Moe", "hair", "Boston", "1:23:45", "cpb-aacip-1234", "AAPB ID", "somewhere else", "5678", "male narrator: IN THE SUMMER OF 1957, LITTLE ROCK, ARKANSAS, WAS CONSIDERED A MODERATE SOUTHERN CITY. THINGS WERE PRETTY NORMAL THERE AS FAMILIES BEGAN TO PREPARE FOR THE COMING SCHOOL YEAR. HOWEVER, THE SHOCKING TRUTH WAS THAT THE CIVIL RIGHTS STRUGGLE HAD COME TO LITTLE ROCK'S CENTRAL HIGH SCHOOL. Captioning byCaptionMax www.captionmax.com"],
