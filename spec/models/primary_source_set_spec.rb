  ...
  describe 'correctly configured' do
    ...
    describe 'source_set?' do
      it 'returns true if set' do
        expect(edu_set.source_set?).to eq(true)
      end
    ...
    describe 'resource?' do
      it 'returns false if set' do
        expect(edu_set.resource?).to eq(false)
      end
      it 'returns true if clip' do
        expect(edu_clip.resource?).to eq(true)
      end
    end
