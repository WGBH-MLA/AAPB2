  ...
  def transcript_message
    @transcript_message ||= begin
      if uncorrected_transcript?
        "This transcript was received from a third party and/or generated by a computer. Its accuracy has not been verified. If this transcript has significant errors that should be corrected, <a href=\"mailto:aapb_notifications@wgbh.org?subject=Transcript:%20#{id}\">let us know</a>, so we can add it using our <a href=\"https://fixitplus.americanarchive.org\" target=\"_blank\">FIX IT+ crowdsourcing tool</a>."
      elsif correcting_transcript?
        "This transcript was received from a third party and/or generated by a computer. Its accuracy has not been verified and may contain errors. <a href=\"https://fixitplus.americanarchive.org/transcripts/#{id}\" target=\"_blank\">Help us correct it on FIX IT+</a>."
      elsif correct_transcript?
        "This transcript has been examined and corrected by a human. Most of our transcripts are computer-generated, then edited by volunteers using our <a href=\"https://fixitplus.americanarchive.org\" target=\"_blank\">FIX IT+ crowdsourcing tool</a>. If this transcript needs further correction, please <a href=\"mailto:aapb_notifications@wgbh.org?subject=Transcript:%20#{id}\">let us know</a>."
      end
    end
  end
