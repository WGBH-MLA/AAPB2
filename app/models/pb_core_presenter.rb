...
class PBCorePresenter
  ...
  def transcript_message
    @transcript_message ||= (uncorrected_transcript? || correcting_transcript?) ? 'This transcript was received from a third party and/or generated by a computer. Its accuracy has not been verified. If this transcript has significant errors that should be corrected, <a href="mailto:aapb_notifications@wgbh.org">let us know</a>, so we can add it to <a href="https://fixitplus.americanarchive.org">FIX IT+</a>.' : nil
  end
  def fixitplus_url
