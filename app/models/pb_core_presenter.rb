  ...
  def transcript_message
    @transcript_message ||= begin
      if uncorrected_transcript?
        ...
        'This transcript has been examined and corrected by a human. Most of our transcripts are computer-generated, then edited by volunteers using our <a href="https://fixitplus.americanarchive.org" target="_blank">FIX IT+</a> crowdsourcing tool. If this transcript needs further correction, please <a href="mailto:aapb_notifications@wgbh.org">let us know</a>.'
      end
    end
  end
