...
This exhibit offers a brief historical overview of *Le Show* from analog to digital and then showcases examples of Shearer's sonic satire and information-sharing on *Le Show* over the decades in “A *Le Show* Sampler.” Be sure to read Shearer’s own recollections of the four decades of Le Show — so far — [here](https://s3.amazonaws.com/americanarchive.org/special-collections/le_show_y1_final.pdf).
